(function(){function j(i,a,b){if(i===a)return 0!==i||1/i==1/a;if(null==i||null==a)return i===a;i._chain&&(i=i._wrapped);a._chain&&(a=a._wrapped);if(i.isEqual&&e.isFunction(i.isEqual))return i.isEqual(a);if(a.isEqual&&e.isFunction(a.isEqual))return a.isEqual(i);var c=l.call(i);if(c!=l.call(a))return!1;switch(c){case "[object String]":return i==""+a;case "[object Number]":return i!=+i?a!=+a:0==i?1/i==1/a:i==+a;case "[object Date]":case "[object Boolean]":return+i==+a;case "[object RegExp]":return i.source==
a.source&&i.global==a.global&&i.multiline==a.multiline&&i.ignoreCase==a.ignoreCase}if("object"!=typeof i||"object"!=typeof a)return!1;for(var d=b.length;d--;)if(b[d]==i)return!0;b.push(i);var d=0,f=!0;if("[object Array]"==c){if(d=i.length,f=d==a.length)for(;d--&&(f=d in i==d in a&&j(i[d],a[d],b)););}else{if("constructor"in i!="constructor"in a||i.constructor!=a.constructor)return!1;for(var h in i)if(e.has(i,h)&&(d++,!(f=e.has(a,h)&&j(i[h],a[h],b))))break;if(f){for(h in a)if(e.has(a,h)&&!d--)break;
f=!d}}b.pop();return f}var d=this,g=d._,a={},b=Array.prototype,c=Object.prototype,f=b.slice,h=b.unshift,l=c.toString,k=c.hasOwnProperty,p=b.forEach,q=b.map,r=b.reduce,n=b.reduceRight,A=b.filter,B=b.every,C=b.some,u=b.indexOf,D=b.lastIndexOf,c=Array.isArray,G=Object.keys,v=Function.prototype.bind,e=function(i){return new s(i)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=e),exports._=e):d._=e;e.VERSION="1.3.3";var m=e.each=e.forEach=function(i,
b,c){if(null!=i)if(p&&i.forEach===p)i.forEach(b,c);else if(i.length===+i.length)for(var d=0,f=i.length;d<f&&!(d in i&&b.call(c,i[d],d,i)===a);d++);else for(d in i)if(e.has(i,d)&&b.call(c,i[d],d,i)===a)break};e.map=e.collect=function(i,a,b){var c=[];if(null==i)return c;if(q&&i.map===q)return i.map(a,b);m(i,function(i,d,e){c[c.length]=a.call(b,i,d,e)});i.length===+i.length&&(c.length=i.length);return c};e.reduce=e.foldl=e.inject=function(i,a,b,c){var d=2<arguments.length;null==i&&(i=[]);if(r&&i.reduce===
r)return c&&(a=e.bind(a,c)),d?i.reduce(a,b):i.reduce(a);m(i,function(i,e,f){d?b=a.call(c,b,i,e,f):(b=i,d=!0)});if(!d)throw new TypeError("Reduce of empty array with no initial value");return b};e.reduceRight=e.foldr=function(i,a,b,c){var d=2<arguments.length;null==i&&(i=[]);if(n&&i.reduceRight===n)return c&&(a=e.bind(a,c)),d?i.reduceRight(a,b):i.reduceRight(a);var f=e.toArray(i).reverse();c&&!d&&(a=e.bind(a,c));return d?e.reduce(f,a,b,c):e.reduce(f,a)};e.find=e.detect=function(a,b,c){var d;E(a,function(a,
i,e){if(b.call(c,a,i,e))return d=a,!0});return d};e.filter=e.select=function(a,b,c){var d=[];if(null==a)return d;if(A&&a.filter===A)return a.filter(b,c);m(a,function(a,i,e){b.call(c,a,i,e)&&(d[d.length]=a)});return d};e.reject=function(a,b,c){var d=[];if(null==a)return d;m(a,function(a,i,e){b.call(c,a,i,e)||(d[d.length]=a)});return d};e.every=e.all=function(i,b,c){var d=!0;if(null==i)return d;if(B&&i.every===B)return i.every(b,c);m(i,function(i,e,f){if(!(d=d&&b.call(c,i,e,f)))return a});return!!d};
var E=e.some=e.any=function(i,b,c){b||(b=e.identity);var d=!1;if(null==i)return d;if(C&&i.some===C)return i.some(b,c);m(i,function(i,e,f){if(d||(d=b.call(c,i,e,f)))return a});return!!d};e.include=e.contains=function(a,b){return null==a?!1:u&&a.indexOf===u?-1!=a.indexOf(b):E(a,function(a){return a===b})};e.invoke=function(a,b){var c=f.call(arguments,2);return e.map(a,function(a){return(e.isFunction(b)?b||a:a[b]).apply(a,c)})};e.pluck=function(a,b){return e.map(a,function(a){return a[b]})};e.max=function(a,
b,c){if(!b&&e.isArray(a)&&a[0]===+a[0])return Math.max.apply(Math,a);if(!b&&e.isEmpty(a))return-Infinity;var d={computed:-Infinity};m(a,function(a,i,e){i=b?b.call(c,a,i,e):a;i>=d.computed&&(d={value:a,computed:i})});return d.value};e.min=function(a,b,c){if(!b&&e.isArray(a)&&a[0]===+a[0])return Math.min.apply(Math,a);if(!b&&e.isEmpty(a))return Infinity;var d={computed:Infinity};m(a,function(a,i,e){i=b?b.call(c,a,i,e):a;i<d.computed&&(d={value:a,computed:i})});return d.value};e.shuffle=function(a){var b=
[],c;m(a,function(a,i){c=Math.floor(Math.random()*(i+1));b[i]=b[c];b[c]=a});return b};e.sortBy=function(a,b,c){var d=e.isFunction(b)?b:function(a){return a[b]};return e.pluck(e.map(a,function(a,b,i){return{value:a,criteria:d.call(c,a,b,i)}}).sort(function(a,b){var i=a.criteria,c=b.criteria;return void 0===i?1:void 0===c?-1:i<c?-1:i>c?1:0}),"value")};e.groupBy=function(a,b){var c={},d=e.isFunction(b)?b:function(a){return a[b]};m(a,function(a,b){var i=d(a,b);(c[i]||(c[i]=[])).push(a)});return c};e.sortedIndex=
...
f.call(a,Math.max(a.length-b,0)):a[a.length-1]};e.rest=e.tail=function(a,b,c){return f.call(a,null==b||c?1:b)};e.compact=function(a){return e.filter(a,function(a){return!!a})};e.flatten=function(a,b){return e.reduce(a,function(a,i){if(e.isArray(i))return a.concat(b?i:e.flatten(i));a[a.length]=i;return a},[])};e.without=function(a){return e.difference(a,f.call(arguments,1))};e.uniq=e.unique=function(a,b,c){var c=c?e.map(a,c):a,d=[];3>a.length&&(b=!0);e.reduce(c,function(c,f,h){if(b?e.last(c)!==f||
...
b[c]});return a};e.pick=function(a){var b={};m(e.flatten(f.call(arguments,1)),function(c){c in a&&(b[c]=a[c])});return b};e.defaults=function(a){m(f.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};e.clone=function(a){return!e.isObject(a)?a:e.isArray(a)?a.slice():e.extend({},a)};e.tap=function(a,b){b(a);return a};e.isEqual=function(a,b){return j(a,b,[])};e.isEmpty=function(a){if(null==a)return!0;if(e.isArray(a)||e.isString(a))return 0===a.length;for(var b in a)if(e.has(a,
b))return!1;return!0};e.isElement=function(a){return!!(a&&1==a.nodeType)};e.isArray=c||function(a){return"[object Array]"==l.call(a)};e.isObject=function(a){return a===Object(a)};e.isArguments=function(a){return"[object Arguments]"==l.call(a)};e.isArguments(arguments)||(e.isArguments=function(a){return!(!a||!e.has(a,"callee"))});e.isFunction=function(a){return"[object Function]"==l.call(a)};e.isString=function(a){return"[object String]"==l.call(a)};e.isNumber=function(a){return"[object Number]"==
l.call(a)};e.isFinite=function(a){return e.isNumber(a)&&isFinite(a)};e.isNaN=function(a){return a!==a};e.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==l.call(a)};e.isDate=function(a){return"[object Date]"==l.call(a)};e.isRegExp=function(a){return"[object RegExp]"==l.call(a)};e.isNull=function(a){return null===a};e.isUndefined=function(a){return void 0===a};e.has=function(a,b){return k.call(a,b)};e.noConflict=function(){d._=g;return this};e.identity=function(a){return a};e.times=
...
this._chain)}});s.prototype.chain=function(){this._chain=!0;return this};s.prototype.value=function(){return this._wrapped}}).call(this);(function(j){j.Parse=j.Parse||{};j.Parse.VERSION="1.0.18"})(this);
(function(){function j(a,b,c){if(a===b)return 0!==a||1/a==1/b;if(null==a||null==b)return a===b;a._chain&&(a=a._wrapped);b._chain&&(b=b._wrapped);if(a.isEqual&&e.isFunction(a.isEqual))return a.isEqual(b);if(b.isEqual&&e.isFunction(b.isEqual))return b.isEqual(a);var d=l.call(a);if(d!=l.call(b))return!1;switch(d){case "[object String]":return a==String(b);case "[object Number]":return a!=+a?b!=+b:0==a?1/a==1/b:a==+b;case "[object Date]":case "[object Boolean]":return+a==+b;case "[object RegExp]":return a.source==
b.source&&a.global==b.global&&a.multiline==b.multiline&&a.ignoreCase==b.ignoreCase}if("object"!=typeof a||"object"!=typeof b)return!1;for(var f=c.length;f--;)if(c[f]==a)return!0;c.push(a);var f=0,h=!0;if("[object Array]"==d){if(f=a.length,h=f==b.length)for(;f--&&(h=f in a==f in b&&j(a[f],b[f],c)););}else{if("constructor"in a!="constructor"in b||a.constructor!=b.constructor)return!1;for(var g in a)if(e.has(a,g)&&(f++,!(h=e.has(b,g)&&j(a[g],b[g],c))))break;if(h){for(g in b)if(e.has(b,g)&&!f--)break;
...
{};return m(e.flatten(f.call(arguments,1)),function(c){c in a&&(b[c]=a[c])}),b};e.defaults=function(a){return m(f.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])}),a};e.clone=function(a){return e.isObject(a)?e.isArray(a)?a.slice():e.extend({},a):a};e.tap=function(a,b){return b(a),a};e.isEqual=function(a,b){return j(a,b,[])};e.isEmpty=function(a){if(null==a)return!0;if(e.isArray(a)||e.isString(a))return 0===a.length;for(var b in a)if(e.has(a,b))return!1;return!0};e.isElement=function(a){return!!a&&
1==a.nodeType};e.isArray=c||function(a){return"[object Array]"==l.call(a)};e.isObject=function(a){return a===Object(a)};e.isArguments=function(a){return"[object Arguments]"==l.call(a)};e.isArguments(arguments)||(e.isArguments=function(a){return!!a&&!!e.has(a,"callee")});e.isFunction=function(a){return"[object Function]"==l.call(a)};e.isString=function(a){return"[object String]"==l.call(a)};e.isNumber=function(a){return"[object Number]"==l.call(a)};e.isFinite=function(a){return e.isNumber(a)&&isFinite(a)};
e.isNaN=function(a){return a!==a};e.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==l.call(a)};e.isDate=function(a){return"[object Date]"==l.call(a)};e.isRegExp=function(a){return"[object RegExp]"==l.call(a)};e.isNull=function(a){return null===a};e.isUndefined=function(a){return void 0===a};e.has=function(a,b){return k.call(a,b)};e.noConflict=function(){return d._=g,this};e.identity=function(a){return a};e.times=function(a,b,c){for(var d=0;d<a;d++)b.call(c,d)};e.escape=function(a){return(""+
...
g.onprogress=function(){};g.open(a,b);g.send(c)};d._ajax=function(a,b,c,f,h){if("undefined"!=typeof XDomainRequest)return d._ajaxIE8(a,b,c,f,h);var g=!1,k=new XMLHttpRequest;k.onreadystatechange=function(){if(4===k.readyState&&!g)if(g=!0,200<=k.status&&300>k.status){var a;try{a=JSON.parse(k.responseText)}catch(b){h&&h(k)}a&&f&&f(a,k)}else h&&h(k)};k.open(a,b,!0);k.setRequestHeader("Content-Type","text/plain");k.send(c)};d._extend=function(a,b){var c,f=this,h;c=(a&&a.hasOwnProperty("constructor")?
...
(function(){var j=this.Parse||(this.Parse={}),d=/\s+/,g=Array.prototype.slice;j.Events={on:function(a,b,c){var f,h,g,k,j;if(!b)return this;a=a.split(d);f=this._callbacks||(this._callbacks={});for(h=a.shift();h;)g=(j=f[h])?j.tail:{},g.next=k={},g.context=c,g.callback=b,f[h]={tail:k,next:j?j.next:g},h=a.shift();return this},off:function(a,b,c){var f,h,g,k,j,q;if(h=this._callbacks){if(!a&&!b&&!c)return delete this._callbacks,this;a=a?a.split(d):_.keys(h);for(f=a.shift();f;)if(g=h[f],delete h[f],g&&(b||
c)){k=g.tail;for(g=g.next;g!==k;)j=g.callback,q=g.context,(b&&j!==b||c&&q!==c)&&this.on(f,j,q),g=g.next;f=a.shift()}return this}},trigger:function(a){var b,c,f,h,l,k;if(!(f=this._callbacks))return this;l=f.all;a=a.split(d);k=g.call(arguments,1);for(b=a.shift();b;){if(c=f[b])for(h=c.tail;(c=c.next)!==h;)c.callback.apply(c.context||this,k);if(c=l){h=c.tail;for(b=[b].concat(k);(c=c.next)!==h;)c.callback.apply(c.context||this,b)}b=a.shift()}return this}};j.Events.bind=j.Events.on;j.Events.unbind=j.Events.off}).call(this);
(function(j){j.Parse=j.Parse||{};var d=j.Parse,g=d._;d.GeoPoint=function(a,b){g.isArray(a)?(d.GeoPoint._validate(a[0],a[1]),this.latitude=a[0],this.longitude=a[1]):g.isObject(a)?(d.GeoPoint._validate(a.latitude,a.longitude),this.latitude=a.latitude,this.longitude=a.longitude):g.isNumber(a)&&g.isNumber(b)?(d.GeoPoint._validate(a,b),this.latitude=a,this.longitude=b):(this.latitude=0,this.longitude=0);var c=this;this.__defineGetter__&&this.__defineSetter__&&(this._latitude=this.latitude,this._longitude=
...
d._each(a,function(d,h){var g=a[h],k=c[h];g&&k?c[h]=k._mergeWithPrevious(g):g&&(c[h]=g)});this._processSaveQueue()},_finishSave:function(a){var c=g.first(this._opSetQueue);this._opSetQueue=g.rest(this._opSetQueue);this._applyOpSet(c,this._serverData);this._mergeMagicFields(a);var f=this;d._each(a,function(a,b){f._serverData[b]=d._decode(b,a)});this._rebuildAllEstimatedData();this._processSaveQueue()},_finishFetch:function(a,c){this._mergeMagicFields(a);var f=this;d._each(a,function(a,b){f._serverData[b]=
...
(h=a,d._each(h,function(a,b){h[b]=d._decode(b,a)}),f=c):(h={},h[a]=d._decode(a,c));f=f||{};if(!h)return this;h instanceof d.Object&&(h=h.attributes);f.unset&&d._each(h,function(a,b){h[b]=new d.Op.Unset});var l=g.clone(h),k=this;d._each(l,function(a,b){a instanceof d.Op&&(l[b]=a._estimate(k.attributes[b],k,b),l[b]===d.Op._UNSET&&delete l[b])});if(!this._validate(h,f))return!1;this._mergeMagicFields(h);f.changes={};var j=this._escapedAttributes;return d._each(g.keys(h),function(a){var b=h[a];b instanceof
d.Relation&&(b.parent=k);b instanceof d.Op||(b=new d.Op.Set(b));var c=!0;b instanceof d.Op.Set&&g.isEqual(k.attributes[a],b.value)&&(c=!1);c&&(delete j[a],f.silent?k._silent[a]=!0:f.changes[a]=!0);var l=g.last(k._opSetQueue);l[a]=b._mergeWithPrevious(l[a]);k._rebuildEstimatedDataForKey(a);c?(k.changed[a]=k.attributes[a],f.silent||(k._pending[a]=!0)):(delete k.changed[a],delete k._pending[a])}),f.silent||this.change(f),this},unset:function(a,c){return c=c||{},c.unset=!0,this.set(a,null,c)},increment:function(a,
...
function(c,d){a[d]=c.toJSON()}),a},fetch:function(a){var a=a?g.clone(a):{},c=this,f=a.success;a.success=function(a,b,d){c._finishFetch(c.parse(a,b,d),!0);f&&f(c,a)};a.error=d.Object._wrapError(a.error,c,a);d._request("classes",c.className,c.id,"GET",null,a)},save:function(a,c,f){var h,l,k;g.isObject(a)||d._isNullOrUndefined(a)?(h=a,k=c):(h={},h[a]=c,k=f);if(!k&&h&&0===g.reject(h,function(a,b){return g.include(["success","error","wait"],b)}).length&&(a=!0,g.has(h,"success")&&!g.isFunction(h.success)&&
(a=!1),g.has(h,"error")&&!g.isFunction(h.error)&&(a=!1),a))return this.save(null,h);k=k?g.clone(k):{};k.wait&&(l=g.clone(this.attributes));var j=g.extend({},k,{silent:!0});if(h&&!this.set(h,k.wait?j:k))return!1;var q=k,r=g.clone(k),n=this;n._refreshCache();a=d.Object._findUnsavedChildren(n.attributes);if(0<a.length)return d.Object.saveAll(a,{success:function(){n.save(null,q)},error:function(a){k.error&&k.error.apply(this,arguments)}}),this;r.success=function(a,b,c){b=n.parse(a,b,c);r.wait&&(b=g.extend(h||
{},b));n._finishSave(b);q.success?q.success(n,a):n.trigger("sync",n,a,r)};r.error=function(){n._cancelSave();q.error&&q.error.apply(this,arguments)};r.error=d.Object._wrapError(r.error,n,r);this._startSave();a=function(){var a=n.id?"PUT":"POST",b=n._getSaveJSON(),c="classes",f=n.className;"_User"===n.className&&!n.id&&(c="users",f=null);d._request(c,f,n.id,a,b,r);r.wait&&n.set(l,j)};return this._saving?(this._saveQueue=this._saveQueue||[],this._saveQueue.push(a)):(this._saving=!0,a()),this},destroy:function(a){var a=
...
a&&(a="_User");var h=null;g.has(d.Object._classMap,a)?h=d.Object._classMap[a]._extend(c,f):(c=c||{},c.className=a,h=d.Object._extend(c,f));return h.extend=function(c){if(g.isString(c)||c&&g.has(c,"className"))return d.Object.extend.apply(h,arguments);var f=[a].concat(d._.toArray(arguments));return d.Object.extend.apply(h,f)},d.Object._classMap[a]=h,h};d.Object._wrapError=function(a,c,f){return function(h,g){h!==c&&(g=h);var j=new d.Error(-1,g.responseText);if(g.responseText){var p=JSON.parse(g.responseText);
p&&(j=new d.Error(p.code,p.error))}a?a(c,j,f):c.trigger("error",c,j,f)}};d.Object._findUnsavedChildren=function(a){var c=[];a instanceof d.Object?(a._refreshCache(),a.dirty()&&(c=[a]),c.push.apply(c,d.Object._findUnsavedChildren(a.attributes))):a instanceof d.Relation||(g.isArray(a)?g.each(a,function(a){c.push.apply(c,d.Object._findUnsavedChildren(a))}):g.isObject(a)&&d._each(a,function(a){c.push.apply(c,d.Object._findUnsavedChildren(a))}));return c}})(this);
(function(j){j.Parse=j.Parse||{};var d=j.Parse,g=d._;d.Role=d.Object.extend("_Role",{constructor:function(a,b){g.isString(a)&&b instanceof d.ACL?(d.Object.prototype.constructor.call(this,null,null),this.setName(a),this.setACL(b)):d.Object.prototype.constructor.call(this,a,b)},getName:function(){return this.get("name")},setName:function(a,b){return this.set("name",a,b)},getUsers:function(){return this.relation("users")},getRoles:function(){return this.relation("roles")},validate:function(a,b){if("name"in
...
(function(j){j.Parse=j.Parse||{};var d=j.Parse,g=d._;d.Collection=function(a,b){b=b||{};b.comparator&&(this.comparator=b.comparator);b.model&&(this.model=b.model);b.query&&(this.query=b.query);this._reset();this.initialize.apply(this,arguments);a&&this.reset(a,{silent:!0,parse:b.parse})};g.extend(d.Collection.prototype,d.Events,{model:d.Object,initialize:function(){},toJSON:function(){return this.map(function(a){return a.toJSON()})},add:function(a,b){var c,f,h,j,k,p={},q={},b=b||{},a=g.isArray(a)?
a.slice():[a];c=0;for(f=a.length;c<f;c++){a[c]=this._prepareModel(a[c],b);h=a[c];if(!h)throw Error("Can't add an invalid model to a collection");j=h.cid;if(p[j]||this._byCid[j])throw Error("Duplicate cid: can't add the same model to a collection twice");k=h.id;if(!d._isNullOrUndefined(k)&&(q[k]||this._byId[k]))throw Error("Duplicate id: can't add the same model to a collection twice");q[k]=h;p[j]=h}for(c=0;c<f;c++)(h=a[c]).on("all",this._onModelEvent,this),this._byCid[h.cid]=h,h.id&&(this._byId[h.id]=
h);this.length+=f;this.models.splice.apply(this.models,[b.at||this.models.length,0].concat(a));this.comparator&&this.sort({silent:!0});if(b.silent)return this;c=0;for(f=this.models.length;c<f;c++)h=this.models[c],p[h.cid]&&(b.index=c,h.trigger("add",h,this,b));return this},remove:function(a,b){var c,d,h,j,b=b||{},a=g.isArray(a)?a.slice():[a];c=0;for(d=a.length;c<d;c++)if(j=this.getByCid(a[c])||this.get(a[c]))delete this._byId[j.id],delete this._byCid[j.cid],h=this.indexOf(j),this.models.splice(h,
1),this.length--,b.silent||(b.index=h,j.trigger("remove",j,this,b)),this._removeReference(j);return this},get:function(a){return a&&this._byId[a.id||a]},getByCid:function(a){return a&&this._byCid[a.cid||a]},at:function(a){return this.models[a]},sort:function(a){a=a||{};if(!this.comparator)throw Error("Cannot sort a set without a comparator");var b=g.bind(this.comparator,this);return 1===this.comparator.length?this.models=this.sortBy(b):this.models.sort(b),a.silent||this.trigger("reset",this,a),this},
...
(function(j){j.Parse=j.Parse||{};var d=j.Parse,g=d._;d.Query=function(a){g.isString(a)&&(a=d.Object._getSubclass(a));this.objectClass=a;this.className=a.prototype.className;this._where={};this._include=[];this._limit=-1;this._skip=0};d.Query.prototype={get:function(a,b){var c=b.success||function(){},f=b.error||function(){};this.equalTo("objectId",a);this.first({error:function(a){f(null,a)},success:function(a){a?c(a):f(null,new d.Error(d.Error.OBJECT_NOT_FOUND,"Object not found."))}})},toJSON:function(){var a=
